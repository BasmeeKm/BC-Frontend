...
import { FaWeight, FaRulerVertical, FaCalendarWeek, FaMapMarkerAlt, FaDna } from 'react-icons/fa';
...
function AssessmentForm() {
  ...
  const handleConsent = async (isConsent) => {
    ...
    try {
      ...
      console.log('Prediction:', resultData.prediction_diag);
      console.log('Probability:', resultData.probability_diag);

      navigate('/result', {
        state: {
          result: resultData.prediction_diag,
          probability: resultData.probability_diag,
    ...
    <div className="app-container">
      ...
      <header className="header-container">
        <div className="header-content">
          ...
          <p className="header-title">ระบบประเมินความเสี่ยงโรคมะเร็งเต้านมด้วยตนเอง</p>
        </div>
      </header>
      ...
      <main className="form-container">
        ...
        <form className="assessment-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label htmlFor="knowBRCA"><FaDna /> ผลตรวจ BRCA </label>
            <select className="form-brca" id="BRCA" value={formData.BRCA} onChange={handleChange} required>
              <option className="form-brca" value="" disabled>กรุณากรอกผลการตรวจ BRCA</option>
